...
# The code below are merged
#   - launch file https://github.com/ros-planning/navigation2/blob/main/nav2_bringup/launch/navigation_launch.py
#   - launch file https://github.com/ros-planning/navigation2/blob/main/nav2_bringup/launch/rviz_launch.py
# For our project purposes it was necessary to add `slam_toolbox_node` and `exploration_node` run
...
from launch.actions import DeclareLaunchArgument, EmitEvent, RegisterEventHandler, GroupAction, SetEnvironmentVariable
